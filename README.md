...
This is a simple web application to download GPX files from Komoot tours.

### How to use

1.  **Find your Komoot tour:** Go to the Komoot website and find the tour you want to download.
...
This project is still a work in progress. If you want to contribute, please feel free to open an issue or a pull request on the [GitHub repository](https://github.com/trezi29/komooot-gpx-downloader).
